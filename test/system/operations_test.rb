...
class OperationsTest < ApplicationSystemTestCase
  ...
  test "visiting the index" do
    ...
    assert_selector "h2", text: "Транзакції"
  end
  ...
  test "should create operation" do
    ...
    assert_text "Транзакція успішно створено."
    click_on "Back"
  end
  ...
  test "should update Operation" do
    ...
    assert_text "Транзакцію успішно оновлено."
    click_on "Back"
  end
  ...
  test "should destroy Operation" do
    ...
    assert_text "Транзакцію було успішно знищено."
  end
end
